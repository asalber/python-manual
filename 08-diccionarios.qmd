...
## Creación de diccionarios con llaves

Para crear un diccionario basta con escribir sus pares entre llaves `{ }` separados por comas. En cada par del diccionario la clave se separa del valor asociado con dos puntos `:`.
