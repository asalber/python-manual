...
\emph{El índice del primer carácter de la cadena es 0.}

También se pueden utilizar índices negativos para recorrer la cadena del
final al principio.

\emph{El índice del último carácter de la cadena es -1.}
...
\emph{Utilizan el orden establecido en el
...
\emph{El valor devuelto siempre es una cadena, incluso si el usuario
introduce un dato numérico.}
...
\subsection{\texorpdfstring{Salida por terminal
...
\emph{Los bloques de código deben estar indentados por 4 espacios.}
...
\emph{El bloque de código debe estar indentado por 4 espacios.}
...
Se construyen poniendo los elementos entre corchetes \texttt{{[}}
...
\subsection{\texorpdfstring{Creación de listas mediante la función
...
\emph{El índice del primer elemento de la lista es 0.}
...
\subsection{Sublistas}\label{sublistas}
...
\subsection{Operaciones que no modifican una
...
\subsection{Operaciones que modifican una
...
\subsection{Copia de listas}\label{copia-de-listas}
...
\subsection{\texorpdfstring{Creación de tuplas mediante la función
...
\section{Diccionarios}\label{diccionarios-1}

Un diccionario es una colección de pares formados por una \emph{clave} y
un \emph{valor} asociado a la clave.

Se construyen poniendo los pares entre llaves \texttt{\{\ \}} separados
por comas, y separando la clave del valor con dos puntos \texttt{:}.
...
\subsection{Operaciones que no modifican un
...
\subsection{Operaciones que modifican un
...
\subsection{Copia de diccionarios}\label{copia-de-diccionarios}
...
\section{\texorpdfstring{Funciones
(\texttt{def})}{Funciones (def)}}\label{funciones-def}
...
\subsection{Parámetros y argumentos de una
...
\subsection{Retorno de una función}\label{retorno-de-una-funciuxf3n}
...
\section{Programación funcional}\label{programaciuxf3n-funcional-1}
...
\subsection{\texorpdfstring{Funciones anónimas
...
\subsection{\texorpdfstring{Aplicar una función a todos los elementos de
...
\subsection{Filtrar los elementos de una colección iterable
(filter)}\label{filtrar-los-elementos-de-una-colecciuxf3n-iterable-filter}
...
\subsection{\texorpdfstring{Combinar los elementos de varias colecciones
iterables
...
\subsection{\texorpdfstring{Operar todos los elementos de una colección
iterable
...
colecciones}\label{comprensiuxf3n-de-colecciones-1}
...
\subsection{Comprensión de listas}\label{comprensiuxf3n-de-listas}
...
\section{Ficheros}\label{ficheros-1}
...
\subsection{Creación y escritura de
...
\subsection{Añadir datos a un
fichero}\label{auxf1adir-datos-a-un-fichero}
...
\subsection{Leer datos de un fichero}\label{leer-datos-de-un-fichero}
...
\subsection{Cerrar un fichero}\label{cerrar-un-fichero}
...
\subsection{\texorpdfstring{La estructura
...
\subsection{Renombrado y borrado de un
...
\subsection{Renombrado y borrado de un fichero o
...
\subsection{Creación, cambio y eliminación de
...
\subsection{Leer un fichero de
internet}\label{leer-un-fichero-de-internet}
...
\section{Control de errores mediante
excepciones}\label{control-de-errores-mediante-excepciones}
...
\subsection{Tipos de excepciones}\label{tipos-de-excepciones}
...
\item
  \texttt{ZeroDivisionError} : Ocurre cuando se itenta dividir por cero.
\item
...
Consultar la documentaciónde Python para ver la
\href{https://docs.python.org/3/library/exceptions.html}{lista de
exepciones predefinidas}.

\subsection{Control de excepciones}\label{control-de-excepciones}

\subsubsection{\texorpdfstring{\texttt{try\ -\ except\ -\ else}}{try - except - else}}\label{try---except---else}

Para evitar la interrución de la ejecución del programa cuando se
produce un error, es posible controlar la exepción que se genera con la
...
\subsection{Control de excepciones}\label{control-de-excepciones-1}
...
\section{Módulos}\label{muxf3dulos-1}
...
\subsection{\texorpdfstring{Importación completa de módulos
...
\subsection{\texorpdfstring{Importación parcial de módulos
...
\subsection{Módulos de la librería estándar más
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/numpy-logo.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/arrays.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/pandas-logo.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/pandas-series.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/pandas-dataframe.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/pandas-grupos.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/formatos-dataframe.png}}
...
\item
  ...
  {\centering \pandocbounded{\includegraphics[keepaspectratio]{img/pandas-concatenacion-filas.png}}
...
\item
  ...
  {\centering \pandocbounded{\includegraphics[keepaspectratio]{img/pandas-concatenacion-columnas.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/matplotlib-logo.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-dispersion.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-puntos.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-lineas.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-areas.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-barras.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-barras-horizontales.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/histograma.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-sectores.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-caja.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-violin.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/diagrama-contorno.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/mapa-calor.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/histograma2D.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/lineas-colores.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/lineas-marcadores.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/lineas-estilo.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/titulo.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/ejes.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/leyenda.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/rejilla.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/multiples-graficos.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/matplotlib-pandas.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/matplotlib-pandas2.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/break-point.png}}
...
sobre el botón
\pandocbounded{\includegraphics[keepaspectratio,alt={Visual Studio Code debbuger}]{img/debug-button.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/debbuger-bar.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{img/debbuger-estado-variables.png}}
